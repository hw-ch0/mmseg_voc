_base_ = ['../_base_/default_runtime.py', '../_base_/datasets/pascal_voc12_aug_mask2former.py']
...
# dataset config
# assign train_pipeline in __base__/datasets//pascal_voc12_aug_mask2former.py
# train_pipeline = [
...
optimizer = dict(
    ...
    # type='AdamW', lr=0.00001, weight_decay=0.05, eps=1e-8, betas=(0.9, 0.999))
